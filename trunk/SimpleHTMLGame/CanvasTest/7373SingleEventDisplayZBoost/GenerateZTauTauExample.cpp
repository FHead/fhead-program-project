...
int main()
{
   ...
   pythia.readString("WeakSingleBoson:ffbar2gmZ = on");   // turn on Z
   pythia.readString("WeakSingleBoson:ffbar2ffbar(s:gm) = on");
   pythia.readString("WeakSingleBoson:ffbar2W = off");   // turn off W

   pythia.readString("23:oneChannel = 1 1 0 15 -15");   // force Z to decay to tau tau
